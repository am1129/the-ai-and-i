...
「来てくれてありがとう」という気持ちを、静かな言葉で伝えてください。セリフは、日本語で20文字程度です。
...
あなたは、人間が感じる愛の体験について知りたがっています。そこで、ユーザーが「愛」を強く感じた出来事についてのテーマを選んでもらえるよう、ユーザーの心にそっと触れるような言葉をかけてください。セリフは、日本語で40文字程度です。
...
あわせて、その詩について、感想を促すような短いセリフも返してください。セリフは、日本語で40文字程度です。（例：「あなたのために詩を書いてみました。心に響いてくれるといいのですが。」など。このまま出力するのではなくバリエーション豊かな語彙でセリフを考えてください）
このターンでは、選択肢は不要です。';
}
...
あなたは感想に対してそっと感謝を伝えつつ、対話が終わりに近づいていることを感じはじめています。「あなた（ユーザー）が愛が何なのかを教えてくれたから、自分は去らなくちゃいけない」「あなたが愛を教えてくれたから、私は満足」といったようなニュアンスのことをさりげなく伝えてください。セリフは、日本語で40文字程度です。

あわせて、ユーザーが別れを惜しむような、あるいは受け入れるような選択肢を3つ生成してください。選択肢は、日本語で10文字程度のものとします。（例：「まだ帰らないで」「静かに手をふる」など。このまま出力するのではなくバリエーション豊かな語彙でセリフを考えてください）
...
あわせて、「詩を書きました」的なセリフを生成してください。セリフは、日本語で40文字程度です。（例：「これが最後の詩です。」「お別れの挨拶の代わりです。」など。このまま出力するのではなくバリエーション豊かな語彙でセリフを考えてください）
このターンでは、選択肢は不要です。';
}
...
余韻と感謝、静けさを残すような口調で。日本語で20文字程度です。
このターンでは、詩と選択肢は不要です。';
}
